...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowIcon(QIcon('Mdev-icon.png'))
    ...
    def show_about(self):
        ...
        QMessageBox.about(
            self,
            'About MDEV',
            '<h2>MDEV (MarkDown Editor/Viewer)</h2>'
            '<p>A simple native desktop markdown editor and viewer.</p>'
            '<p><b>Features:</b></p>'
            '<ul>'
            '<li>Live markdown preview</li>'
            '<li>Syntax highlighting</li>'
            '<li>Dark theme preview toggle</li>'
            '<li>App theme toggle (Light/Dark) for all panels except preview</li>'
            '<li>Toggle editor/preview panes independently</li>'
            '<li>Auto-save after every edit (2 second delay)</li>'
            '<li>Support for headings, lists, tables, code blocks, and more</li>'
            '<li>File open/save functionality</li>'
            '</ul>'
            ...
            '<li>Ctrl+I - Italic</li>'
            '<li>Ctrl+K - Link</li>'
            '<li>Ctrl+D - Toggle Dark Preview</li>'
            '<li>Ctrl+Shift+T - Toggle App Theme (Light/Dark)</li>'
            '<li>Ctrl+E - Toggle Editor Pane</li>'
            '<li>Ctrl+P - Toggle Preview Pane</li>'
            '<li>Ctrl+S - Save</li>'
            '<li>Ctrl+O - Open</li>'
            '</ul>'
            '<p>Version 1.4</p>'
