...
class AppToolbar(QToolBar):
    ...
    def setup_ui(self):
        ...
        self.undo_action.setShortcut(constants.SHORTCUTS['undo'])
        ...
        self.redo_action.setShortcut(constants.SHORTCUTS['redo'])
        ...
        self.cut_action.setShortcut(constants.SHORTCUTS['cut'])
        ...
        self.copy_action.setShortcut(constants.SHORTCUTS['copy'])
        ...
        self.paste_action.setShortcut(constants.SHORTCUTS['paste'])
